...
internal class BackgroundRenderer {
    ...
    private fun createProgram(vertexSource: String, fragmentSource: String): Int {
        ...
        check(status[0] == GLES20.GL_TRUE) { "Could not link camera shader: ${GLES20.glGetProgramInfoLog(result)}" }
    ...
    private fun compileShader(type: Int, source: String): Int {
        ...
        check(status[0] == GLES20.GL_TRUE) { "Could not compile camera shader: ${GLES20.glGetShaderInfoLog(shader)}" }
        return shader
    }
